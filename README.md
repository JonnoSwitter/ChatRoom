...
## 项目总结：
本项目后端所涉及的关键技术包括：asio库实现异步编程、并发编程、网络编程等。具体一点的的包括线程池、连接池、TCP通信、线程安全、互斥锁等技术或概念。
## 环境包：
redis、mysql（本地数据库）等：<img width="467" height="239" alt="image" src="https://github.com/user-attachments/assets/b052054a-7ddb-496f-9d46-62bebf370153" />
node.json：<img width="602" height="294" alt="image" src="https://github.com/user-attachments/assets/c3e53370-2410-4d70-b3b7-a84757701b00" />
## 相关软件：Qt、VS、VSCode。
（VS暂时不要使用2026版，因为本人在redis配置过程中发现其不兼容2026版，所以本人使用的是2022版的VS）
## 鸣谢
